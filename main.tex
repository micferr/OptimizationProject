...
\bibitem {Gurobi} Gurobi, \url{http://www.gurobi.com}
\bibitem {Cplex} IBM CPLEX Optimizer, \url{https://www.ibm.com/analytics/cplex-optimizer}
\bibitem {JsonModern} JSON for Modern C++, \url{https://nlohmann.github.io/json/}
\bibitem {stb} stb, \url{https://github.com/nothings/stb}
